...
$INPUT      DUMMY=DROP ID TIME WEEK DOSE=AMT RATE CONC=DROP ADA BW
            ALB=DROP SEX=DROP AGE=DROP CREAT COL EVID BLQ CONC_M7=DV
...
$THETA  (0.001,1.54032,4.5) ; [1]   CL (L/d)
 (0.001,4.74853,8) ; [2,3] V1  (L)
 (0.01,0.107987,3) ; V2
 (0.001,1.24486,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.12368,5) ; CLADA1
$THETA  (-1,-0.268167,5) ; V1ADA1
$THETA  (-0.054,-0.0535099,0.042) ; V1BW1
$THETA  (-1.250,0.192985,1.190) ; V1CREAT1
...
$OMEGA  0.583889  ;     IIV CL
 0.647418  ;     IIV V1
$SIGMA  0.289387  ; EPS(1), proportional
