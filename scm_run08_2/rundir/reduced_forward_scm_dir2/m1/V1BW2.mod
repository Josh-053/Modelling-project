...
$THETA  (0.001,1.38731,4.5) ; [1]   CL (L/d)
 (0.001,4.34087,8) ; [2,3] V1  (L)
 (0.01,0.444502,3) ; V2
 (0.001,3.34268,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.85981,5) ; CLADA1
$THETA  (-0.054,4.2E-05,0.042) ; V1BW1
...
$OMEGA  0.464416  ;     IIV CL
 0.233521  ;     IIV V1
$SIGMA  0.28167  ; EPS(1), proportional
