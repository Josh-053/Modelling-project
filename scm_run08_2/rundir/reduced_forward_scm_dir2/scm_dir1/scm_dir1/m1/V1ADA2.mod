...
$THETA  (0.001,1.43159,4.5) ; [1]   CL (L/d)
 (0.001,4.9331,8) ; [2,3] V1  (L)
 (0.01,0.105244,3) ; V2
 (0.001,1.88421,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.92604,5) ; CLADA1
$THETA  (-0.134,-0.126969,0.085) ; V1ALB1
$THETA  (-0.054,-0.0534596,0.042) ; V1BW1
...
$OMEGA  0.615245  ;     IIV CL
 0.634313  ;     IIV V1
$SIGMA  0.291366  ; EPS(1), proportional
