...
$THETA  (0.001,1.62655,4.5) ; [1]   CL (L/d)
 (0.001,3.91927,8) ; [2,3] V1  (L)
 (0.01,0.245,3) ; V2
 (0.001,2.6056,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.59099,5) ; CLADA1
$THETA  (-0.134,-0.127538,0.085) ; V1ALB1
...
$OMEGA  0.636831  ;     IIV CL
 0.412367  ;     IIV V1
$SIGMA  0.287725  ; EPS(1), proportional
