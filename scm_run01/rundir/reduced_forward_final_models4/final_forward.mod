...
$THETA  (0.001,1.48845,8) ; [1]   CL (L/d)
 (0.001,5.57892,10) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.89416,5) ; CLADA1
$THETA  (-100000,0.0210443,0.084) ; VALB1
 (-0.134,-0.126608,100000) ; VALB2
$THETA  (-0.055,-0.0255435,0.042) ; VBW1
...
$OMEGA  0.653039  ;     IIV CL
 0.316708  ;      IIV V
$SIGMA  0.280732  ; EPS(1), proportional
