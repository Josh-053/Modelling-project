...
VBW = ( 1 + THETA(5)*(BW - 65.93))
;;; VBW-DEFINITION END


;;; VALB-DEFINITION START
VALB = ( 1 + THETA(4)*(ALB - 31.85))
;;; VALB-DEFINITION END
...
$THETA  (0.001,1.49669,8) ; [1]   CL (L/d)
 (0.001,4.55552,10) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.36547,5) ; CLADA1
$THETA  (-0.134,-0.125784,0.084) ; VALB1
$THETA  (-0.055,4.2E-05,0.042) ; VBW1
...
$OMEGA  0.602029  ;     IIV CL
 0.363604  ;      IIV V
$SIGMA  0.283065  ; EPS(1), proportional
