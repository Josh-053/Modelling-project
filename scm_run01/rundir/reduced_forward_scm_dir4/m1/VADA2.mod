...
$THETA  (0.001,1.49958,8) ; [1]   CL (L/d)
 (0.001,5.60429,10) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.51441,5) ; CLADA1
$THETA  (-100000,-0.00274293,0.084) ; VALB1
 (-0.134,-0.125285,100000) ; VALB2
...
$OMEGA  0.600868  ;     IIV CL
 0.27066  ;      IIV V
$SIGMA  0.283307  ; EPS(1), proportional
