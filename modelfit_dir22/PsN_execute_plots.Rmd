...
#Created 2025-12-22 at 17:14

xpose.runno <- '04.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Modelling-project/modelfit_dir22/'
results.directory <- '..'
...
omega.labels <- c('IIV VMAX','IIV KM','IIV V1 [5]','IIV V2 [5]')
