...
#Created 2026-01-07 at 13:49

xpose.runno <- '12.mod'
toolname <- 'sir'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Modelling-project/sir_run12/'
results.directory <- '..'
...
raw.results.file <- 'raw_results_run12.csv'
...
SAMPLES          <-2000
RESAMPLES        <-1000
ALL.SAMPLES      <-c(1000,1000,1000,2000,2000)
ALL.RESAMPLES    <-c(200,400,500,1000,1000)
ALL.RAWRESFILES   <-c('raw_results_sir_iteration1.csv','raw_results_sir_iteration2.csv','raw_results_sir_iteration3.csv','raw_results_sir_iteration4.csv','raw_results_run12.csv')
MAX.RESAMPLE <- 1    # maximum resamples for single sample. 1 if without replacement
COL.ESTIMATED.PARAMS <-  c(29:37)   #column numbers in raw_results for parameters
N.ESTIMATED.PARAMS <- 9
N.ESTIMATED.THETAS <- 6
N.ESTIMATED.OMEGAS <- 2
