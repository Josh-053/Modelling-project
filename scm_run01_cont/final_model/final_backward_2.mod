...
(0.001,  6.25,      15) ; V (L) [2,3]
(-1,     3.74,       9) ; CLADA
(-1,    -0.283,      5) ; VADA
(-100,   0.0186,  0.084) ; VALB1
(-0.134,-0.127,    100) ; VALB2
(-0.055,  -0.0462, 0.042) ; VBW
(-1.250, 0.258,  1.190) ; VCREAT
...
$OMEGA
0.611 ; IIV CL (value obtained from SCM+)
0.425 ; IIV V

$SIGMA    ; residual variability
0.281  ; EPS(1), proportional (value obtained from SCM+)
