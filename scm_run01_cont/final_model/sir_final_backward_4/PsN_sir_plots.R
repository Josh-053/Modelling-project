...
#Created 2026-01-06 at 18:13

xpose.runno <- '4.mod'
toolname <- 'sir'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Modelling-project/scm_run01_cont/final_model/sir_final_backward_4/'
results.directory <- '..'
...
raw.results.file <- 'raw_results_final_backward_4.csv'
...
RESAMPLES        <-1000
ALL.SAMPLES      <-c(2000)
ALL.RESAMPLES    <-c(1000)
ALL.RAWRESFILES   <-c('raw_results_final_backward_4.csv')
