...
$THETA  (0.001,1.39797,8) ; CL (L/d) [1]
 (0.001,4.96413,15) ; V (L) [2,3]
 (0.001,4.01979,9) ; CLADA
 (-1,-0.262909,2) ; VADA
 (-0.138,-0.124656,0.084) ; VALB
 (-0.4,0.183952,0.4) ; VCREAT
...
$OMEGA  0.60363  ; IIV CL (value obtained from SCM+)
 0.369616  ;      IIV V
$SIGMA  0.28265  ; EPS(1), proportional (value obtained from SCM+)
 5E-13  FIX  ;     EPS(2)  ; additive, required by M7+ censoring method
    ; residual variability
$SIMULATION (968441114) ONLYSIMULATION NSUBPROBLEMS=1000
$TABLE      ID MDV TAD CONC_M7 ONEHEADER NOPRINT NOAPPEND IDFORMAT=I
            FILE=npctab.dta
