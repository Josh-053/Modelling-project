...
#Created 2026-01-06 at 01:40

xpose.runno <- '3.mod'
toolname <- 'vpc'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Modelling-project/scm_run01_cont/final_model/vpc_final_bw_3_1000samples/'
results.directory <- '..'
...
theta.labels <- c('CL (L/d) [1]','V (L) [2,3]','CLADA','VADA','VALB','VBW','VCREAT')
