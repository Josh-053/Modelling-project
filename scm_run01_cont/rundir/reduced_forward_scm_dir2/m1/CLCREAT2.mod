...
CLCREAT = ( 1 + THETA(8)*(CREAT - 1.04))
;;; CLCREAT-DEFINITION END


;;; VBW-DEFINITION START
IF(BW.LE.65.93) VBW = ( 1 + THETA(6)*(BW - 65.93))
IF(BW.GT.65.93) VBW = ( 1 + THETA(7)*(BW - 65.93))
;;; VBW-DEFINITION END
...
$THETA  (0.001,1.44076,8) ; [1]   CL (L/d)
 (0.001,7.34693,10) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.80504,5) ; CLADA1
$THETA  (-100000,0.0154708,0.084) ; VALB1
 (-0.134,-0.126077,100000) ; VALB2
$THETA  (-100000,0.0118202,0.042) ; VBW1
 (-0.055,-0.0499175,100000) ; VBW2
...
$OMEGA  0.615113  ;     IIV CL
 0.352609  ;      IIV V
$SIGMA  0.282244  ; EPS(1), proportional
