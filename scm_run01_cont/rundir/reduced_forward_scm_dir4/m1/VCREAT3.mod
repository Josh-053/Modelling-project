...
IF(CREAT.LE.1.03) VCREAT = ( 1 + THETA(9)*(CREAT - 1.03))
IF(CREAT.GT.1.03) VCREAT = ( 1 + THETA(10)*(CREAT - 1.03))
...
$THETA  (-100000,0.019778,0.084) ; VALB1
 (-0.134,-0.125712,100000) ; VALB2
$THETA  (-100000,0.0144423,0.042) ; VBW1
 (-0.055,-0.0497278,100000) ; VBW2
$THETA  (-100000,0.264683,1.190) ; VCREAT1
 (-1.250,-0.00125,100000) ; VCREAT2
