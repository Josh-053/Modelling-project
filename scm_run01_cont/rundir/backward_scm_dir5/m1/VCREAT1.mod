...
$THETA  (0.001,1.42,8) ; [1]   CL (L/d)
 (0.001,7.59,16) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.01,5) ; CLADA1
$THETA  (-1,-0.278,5) ; VADA1
$THETA  (-100000,0.0183,0.084) ; VALB1
 (-0.134,-0.126,100000) ; VALB2
$THETA  (-100000,0.0133,0.042) ; VBW1
 (-0.055,-0.0497,100000) ; VBW2
...
$OMEGA  0.613  ;     IIV CL
 0.352  ;      IIV V
$SIGMA  0.282  ; EPS(1), proportional
