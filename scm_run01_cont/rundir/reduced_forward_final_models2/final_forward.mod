...
$THETA  (0.001,1.44345,8) ; [1]   CL (L/d)
 (0.001,7.33528,10) ; [2,3] V  (L)
 ; values are determined in 3 iterations
$THETA  (-1,4.16415,5) ; CLADA1
$THETA  (-100000,0.0157918,0.084) ; VALB1
 (-0.134,-0.126726,100000) ; VALB2
$THETA  (-100000,0.0138469,0.042) ; VBW1
 (-0.055,-0.0497037,100000) ; VBW2
$THETA  (-1,-0.269466,5) ; VADA1
...
$OMEGA  0.615267  ;     IIV CL
 0.358588  ;      IIV V
$SIGMA  0.281927  ; EPS(1), proportional
