...
#Created 2025-12-22 at 11:49

xpose.runno <- '04.mod'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'/home/ali/Documents/GitHub/Modelling-project/modelfit_dir12/'
results.directory <- '..'
...
theta.labels <- c('CL [1]','V1 [2,3]','V2','Q','PROP error ()','ADD (mg/L)')
