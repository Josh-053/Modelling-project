...
$PROBLEM PMX001 Two Compartment TMDDLinear + Michaelis-Menten Model
;; It's basically Target-Mediated Drug Disposition with two assumptions:
...
(0.001, 0.57708, 0.8) ; [1] CL (L/d)
(0.001, 2.8832, 10)  ; VMAX
(0.001, 0.005, 0.02)    ; KM
(0.001, 4.8892, 10)   ; [2,3] V1 (L)
(0.01,  0.16332, 0.5)  ; V2
(0.001, 1.4884, 3)   ; Q
