...
$INPUT      DUMMY=DROP ID TIME WEEK DOSE=AMT RATE CONC=DROP ADA
            BW=DROP ALB SEX=DROP AGE=DROP CREAT COL EVID BLQ
            CONC_M7=DV
...
V1CREAT = ( 1 + THETA(7)*(CREAT - 1.03))
;;; V1CREAT-DEFINITION END


;;; V1ALB-DEFINITION START
V1ALB = ( 1 + THETA(6)*(ALB - 31.85))
...
$THETA  (0.001,1.42087,8) ; [1]   CL (L/d)
 (0.001,4.70545,10) ; [2,3] V1  (L)
 (0.01,0.276092,6) ; V2
 (0.001,2.03659,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.6281,5) ; CLADA1
$THETA  (-0.134,-0.125659,0.084) ; V1ALB1
...
$OMEGA  0.590362  ;     IIV CL
 0.378726  ;      IIV V
$SIGMA  0.280494  ; EPS(1), proportional
