...
IF(CREAT.LE.1.03) V1CREAT = ( 1 + THETA(11)*(CREAT - 1.03))
IF(CREAT.GT.1.03) V1CREAT = ( 1 + THETA(12)*(CREAT - 1.03))
...
$THETA  (0.001,1.40331,8) ; [1]   CL (L/d)
 (0.001,7.46502,10) ; [2,3] V1  (L)
 (0.01,0.190637,6) ; V2
 (0.001,1.36825,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.17631,5) ; CLADA1
$THETA  (-1,-0.273517,5) ; V1ADA1
$THETA  (-100000,0.0147225,0.084) ; V1ALB1
 (-0.134,-0.126753,100000) ; V1ALB2
$THETA  (-100000,0.01249,0.042) ; V1BW1
 (-0.055,-0.0511892,100000) ; V1BW2
$THETA  (-100000,0.278284,1.190) ; V1CREAT1
...
$OMEGA  0.604898  ;     IIV CL
 0.372301  ;      IIV V
$SIGMA  0.278784  ; EPS(1), proportional
