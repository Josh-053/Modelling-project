...
IF(CREAT.LE.1.03) V1CREAT = ( 1 + THETA(12)*(CREAT - 1.03))
IF(CREAT.GT.1.03) V1CREAT = ( 1 + THETA(13)*(CREAT - 1.03))
...
$THETA  (-100000,0.0145913,0.084) ; V1ALB1
 (-0.134,-0.126771,100000) ; V1ALB2
$THETA  (-100000,0.0126373,0.042) ; V1BW1
 (-0.055,-0.0510103,100000) ; V1BW2
$THETA  (-100000,0.277515,1.190) ; V1CREAT1
