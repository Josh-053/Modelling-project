...
IF(AGE.LE.33.17) CLAGE = ( 1 + THETA(13)*(AGE - 33.17))
IF(AGE.GT.33.17) CLAGE = ( 1 + THETA(14)*(AGE - 33.17))
;;; CLAGE-DEFINITION END


;;; V1CREAT-DEFINITION START
V1CREAT = ( 1 + THETA(12)*(CREAT - 1.03))
...
$THETA  (-1.250,0.294921,1.190) ; V1CREAT1
$THETA  (-100000,0.0296695,0.074) ; CLAGE1
