...
IF(CREAT.LE.1.03) V1CREAT = ( 1 + THETA(13)*(CREAT - 1.03))
IF(CREAT.GT.1.03) V1CREAT = ( 1 + THETA(14)*(CREAT - 1.03))
...
$THETA  (0.001,1.44864,8) ; [1]   CL (L/d)
 (0.001,7.63065,10) ; [2,3] V1  (L)
 (0.01,0.246289,6) ; V2
 (0.001,1.7498,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.20123,5) ; CLADA1
$THETA  (-0.050,0.0296695,0.074) ; CLAGE1
$THETA  (-0.135,0.0255106,0.084) ; CLALB1
$THETA  (-1,-0.272378,5) ; V1ADA1
$THETA  (-100000,0.0289067,0.084) ; V1ALB1
 (-0.134,-0.12617,100000) ; V1ALB2
$THETA  (-100000,0.0135637,0.042) ; V1BW1
 (-0.055,-0.0513344,100000) ; V1BW2
$THETA  (-100000,0.294921,1.190) ; V1CREAT1
...
$OMEGA  0.591111  ;     IIV CL
 0.367604  ;      IIV V
$SIGMA  0.278587  ; EPS(1), proportional
