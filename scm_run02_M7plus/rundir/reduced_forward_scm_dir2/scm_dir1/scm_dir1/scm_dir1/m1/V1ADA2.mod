...
$THETA  (0.001,1.40467,8) ; [1]   CL (L/d)
 (0.001,5.96635,10) ; [2,3] V1  (L)
 (0.01,0.193574,6) ; V2
 (0.001,1.40811,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,4.66603,5) ; CLADA1
$THETA  (-100000,0.0172988,0.084) ; V1ALB1
 (-0.134,-0.127504,100000) ; V1ALB2
$THETA  (-0.055,-0.0470322,0.042) ; V1BW1
...
$OMEGA  0.602005  ;     IIV CL
 0.45124  ;      IIV V
$SIGMA  0.280408  ; EPS(1), proportional
