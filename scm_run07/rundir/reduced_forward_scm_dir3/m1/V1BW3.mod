...
$THETA  (0.001,0.938294,10) ; [1]   CL (L/d)
 (0.001,2.35983,10) ; [2,3] V1  (L)
 (0.01,0.0383586,10) ; V2
 (0.001,1.28534,10) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,-0.876653,5) ; V1ADA1
$THETA  (-100000,-0.00247114,0.042) ; V1BW1
...
$OMEGA  0.54885  ;     IIV V1
;0.573 ; IIV CL
$SIGMA  1.31259  ; EPS(1), proportional
