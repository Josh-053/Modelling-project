...
$THETA  (0.001,1.48,8) ; [1]   CL (L/d)
 (0.001,4.61,10) ; [2,3] V1  (L)
 (0.01,0.349,6) ; V2
 (0.001,2.71,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-1,-0.001,5) ; CLADA1
$THETA  (-0.050,-5E-05,0.074) ; CLAGE1
$THETA  (-100000,8.4E-05,0.084) ; CLALB1
 (-0.135,-0.000135,100000) ; CLALB2
$THETA  (-1,-0.001,5) ; V1ADA1
$THETA  (-100000,8.4E-05,0.084) ; V1ALB1
 (-0.134,-0.000134,100000) ; V1ALB2
$THETA  (-100000,4.2E-05,0.042) ; V1BW1
 (-0.055,-5.5E-05,100000) ; V1BW2
$THETA  (-1.250,0.00119,1.190) ; V1CREAT1
