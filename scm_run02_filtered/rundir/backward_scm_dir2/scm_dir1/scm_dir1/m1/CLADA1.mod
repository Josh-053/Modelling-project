...
$INPUT      DUMMY=DROP ID TIME WEEK DOSE=AMT RATE CONC=DROP ADA BW ALB
            SEX AGE=DROP CREAT=DROP COL EVID BLQ CONC_M7=DV
...
$THETA  (0.001,1.24662,8) ; [1]   CL (L/d)
 (0.001,6.84355,10) ; [2,3] V1  (L)
 (0.01,0.215122,6) ; V2
 (0.001,1.72058,6) ; Q
 ; values are determined in 3 iterations
$THETA  (-100000,-0.0854465,0.084) ; CLALB1
 (-0.135,0.175163,100000) ; CLALB2
$THETA  (-1,-0.264732,5) ; V1ADA1
$THETA  (-100000,-0.0272904,0.084) ; V1ALB1
 (-0.134,-0.123732,100000) ; V1ALB2
$THETA  (-100000,0.0203931,0.042) ; V1BW1
 (-0.055,-0.0540142,100000) ; V1BW2
...
$OMEGA  0.675081  ;     IIV CL
 0.44369  ;      IIV V
$SIGMA  0.281744  ; EPS(1), proportional
