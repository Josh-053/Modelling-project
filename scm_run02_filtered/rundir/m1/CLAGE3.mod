...
IF(AGE.LE.33.17) CLAGE = ( 1 + THETA(14)*(AGE - 33.17))
IF(AGE.GT.33.17) CLAGE = ( 1 + THETA(15)*(AGE - 33.17))
;;; CLAGE-DEFINITION END


;;; V1CREAT-DEFINITION START
V1CREAT = ( 1 + THETA(13)*(CREAT - 1.03))
;;; V1CREAT-DEFINITION END


;;; V1BW-DEFINITION START
IF(BW.LE.65.93) V1BW = ( 1 + THETA(11)*(BW - 65.93))
IF(BW.GT.65.93) V1BW = ( 1 + THETA(12)*(BW - 65.93))
;;; V1BW-DEFINITION END


;;; V1ALB-DEFINITION START
IF(ALB.LE.31.85) V1ALB = ( 1 + THETA(9)*(ALB - 31.85))
IF(ALB.GT.31.85) V1ALB = ( 1 + THETA(10)*(ALB - 31.85))
;;; V1ALB-DEFINITION END


;;; V1ADA-DEFINITION START
IF(ADA.EQ.0) V1ADA = 1  ; Most common
IF(ADA.EQ.1) V1ADA = ( 1 + THETA(8))
...
$THETA  (-1.250,0.270336,1.190) ; V1CREAT1
$THETA  (-100000,0.022661,0.074) ; CLAGE1
 (-0.050,-5E-05,100000) ; CLAGE2
